  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild disabled={disabled}>
        <Button
          size="xs"
          className={`bg-background-raised hover:bg-background-raised py-1.5 pl-3 ${className || ''}`}
        >
          ...
          <div className="max-h-[240px] overflow-auto">
            {items.map((item) => (
              <DropdownMenuCheckboxItem
                ...
                className="group relative flex cursor-pointer select-none items-center p-1 pl-2 outline-none transition-colors hover:bg-background-raised! data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>span[data-state='checked']]:hidden"
