...
async function TermsOfUse() {
  return (
    <div className="mx-auto my-12 flex max-w-[1200px] flex-col items-start gap-6 px-6 text-secondary">
      ...
      <p className="text-secondary">
        The Website is a copyrighted work belonging to Sequence Platforms ULC.
        (&ldquo;
        <strong className="text-primary font-semibold">
          Sequence Platforms ULC
        </strong>
        ,&rdquo; &ldquo;
      ...
      <p className="text-secondary">
        ...
        time transferring your assets to us and that Sequence will never be in
      ...
      <p className="text-secondary">
        ...
        with the laws of your jurisdiction and acknowledge that Sequence is not
      ...
      <p className="text-secondary">
        Sequence reserves the right to determine what conduct it considers to be
        a breach of these representations. Sequence reserves the right to take
        action as a result, which may include prohibiting you from accessing
        services provided by Sequence, in whole or in part. Any restrictions
        imposed by Sequence will not affect your ability to transfer your
        digital assets.&nbsp;
      </p>
      <p className="text-secondary">
      ...
      <p className="text-secondary">
        ...
        may fluctuate. Sequence makes no guarantees as to the price or value of
      ...
      <p className="text-secondary">
        ...
        Sequence is not responsible for determining whether there are tax
        implications in connection with such transactions, for reporting any
        such transactions, or for paying any applicable taxes.
      </p>
      <p className="text-secondary">
        <strong className="text-primary font-semibold">(i)</strong>
        &nbsp;Sequence may modify or discontinue support for the Website at any
        time. Sequence reserves the right, at any time and without notice, in
        our sole and absolute discretion, to modify the Website.
      </p>
      ...
      <p className="text-secondary">
        ...
        Sequence grants you a non-transferable, non-exclusive, revocable,
        limited license to use and access the Website for your own personal and
        non-commercial use.
      </p>
      <p className="text-secondary">
        ...
        part of the Website without Sequence&rsquo;s express prior written
        ...
        Marketplace Services without Sequence&rsquo;s express prior written
      ...
      <p className="text-secondary">
        ...
        Sequence reserves the right, at any time, to modify, suspend, or
        discontinue the Website (in whole or in part) with or without notice to
        you. You agree that Sequence will not be liable to you or to any third
      ...
      <p className="text-secondary">
        ...
        You acknowledge and agree that Sequence will have no obligation to
      ...
      <p className="text-secondary">
        ...
        owned by Sequence. Neither these Sequence Marketplace User Interface
        ...
        these Sequence Marketplace User Interface Terms. Sequence reserves all
      ...
      <p className="text-secondary">
        ...
        you. Sequence does not control and is not responsible for the content of
      ...
      <p className="text-secondary">
        ...
        deployed to the Relevant Blockchain. Sequence does not have control over
      ...
      <p className="text-secondary">
        ...
        AND &ldquo;AS AVAILABLE&rdquo; BASIS, AND SEQUENCE (AND OUR SUPPLIERS)
      ...
      <p className="text-secondary">
        SEQUENCE DOES NOT ENDORSE ANY OTHER THIRD PARTY AND SHALL NOT BE
        RESPONSIBLE IN ANY WAY FOR ANY TRANSACTIONS YOU ENTER INTO WITH OTHER
        USERS OF THE NIFTYSWAP PROTOCOL. YOU AGREE THAT SEQUENCE WILL NOT BE
      ...
      <p className="text-secondary">
        ...
        involve removal of your User Content from our live databases. Sequence
      ...
      <p className="text-secondary">
        You agree to indemnify and hold Sequence (and its officers, employees,
        ...
        third-party services. Sequence reserves the right, at your expense, to
        ...
        written consent of Sequence. Sequence will use reasonable efforts to
      ...
      <p className="text-secondary">
        TO THE MAXIMUM EXTENT PERMITTED BY LAW, IN NO EVENT SHALL SEQUENCE BE
        ...
        EVEN IF SEQUENCE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES.
        ...
        SEQUENCE SHALL NOT BE LIABLE UNDER ANY CIRCUMSTANCES FOR DAMAGES ARISING
      ...
      <p className="text-secondary">
        SEQUENCE SHALL NOT BE LIABLE FOR ANY LOSS OR DAMAGE ARISING OUT OF YOUR
      ...
      <p className="text-secondary">
        ...
        Sequence and affects your rights. You and Sequence are each considered
      ...
      <p className="text-secondary">
        Sequence is located in Ontario, Canada. If you are a California
      ...
      <p className="text-secondary">
        The communications between you and Sequence use electronic means,
        whether you use the Sequence Marketplace Services or send us emails, or
        whether Sequence posts notices on the Sequence Marketplace Services or
        communicates with you via email. For contractual purposes, you: (i)
        consent to receive communications from Sequence in an electronic form;
        and (ii) agree that all terms and conditions, agreements, notices,
        disclosures, and other communications that Sequence provides to you
      ...
      <p className="text-secondary">
        ...
        use in some jurisdictions. Sequence and its partners do not represent or
      ...
      <p className="text-secondary">
        ...
        person. Your relationship to Sequence is that of an independent
        ...
        otherwise transferred by you without Sequence&rsquo;s prior written
      ...
      <p className="text-secondary">
        ...
        by Sequence of any right or remedy under these Sequence Marketplace User
        Interface Terms shall only be effective if it is in writing, executed by
        a duly authorized representative of Sequence and shall apply only to the
      ...
      <p className="text-secondary">
        ...
        Copyright &copy; 2022 Sequence Platforms ULC. All rights reserved. All
      ...
      <p className="text-secondary">
        ...
        <a
          target="_blank"
          rel="noreferrer"
          href="mailto:contact@sequence.xyz"
          className="text-primary underline"
        >
          contact@sequence.xyz
        </a>
        .
      </p>{' '}
    </div>
