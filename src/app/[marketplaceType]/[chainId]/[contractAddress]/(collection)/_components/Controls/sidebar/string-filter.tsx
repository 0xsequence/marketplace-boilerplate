...
import type { FilterProps } from './property-filters';
        ...
        {showSearchInput ? (
          ...
          >
            <SearchInput
              ...
              id="property-search"
              placeholder="Search"
              className="border-border-normal focus-within:border-border-normal h-9 rounded-md [&>div]:pl-2 [&>div>svg]:w-4 [&>div>svg]:h-4  [&>div>svg]:text-gray-500"
              value={search}
