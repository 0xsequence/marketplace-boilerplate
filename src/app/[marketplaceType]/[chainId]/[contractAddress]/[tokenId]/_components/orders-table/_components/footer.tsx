...
import { CustomSelect, type SelectItem } from '~/components/select';
import CustomSkeleton from '~/components/skeleton';
import { Table } from '~/components/table';

import { type PageState } from '../../pagination/pagination-context';
import { PAGE_SIZE_OPTIONS } from '../orders-table';
import {
  ChevronLeftIcon,
  ChevronRightIcon,
  IconButton,
  ...
  return (
    <div className="flex sm:flex! items-center gap-2">
      ...
      <CustomSelect
        ...
        onValueChange={(value: string) => page.set('pageSize', Number(value))}
      />
    </div>
  );
}
  ...
  return (
    <div className="flex sm:flex! items-center gap-2">
      <CustomSelect
        ...
        onValueChange={(value: string) => page.set('page', Number(value))}
      />
      {totalPagesLoading ? (
        <CustomSkeleton />
      ) : (
